  ...
  return (
    <div>
      ...
      >
        <div>
          <div>
            if <b>ignoreChildrenLinks</b> is setted as <b>true</b>, all children
            links will be ifnored
          </div>
      ...
      >
        <div>
          {window.location.hash === "#i" ? (
            <div>
              <div>
                Add "custom-ignore" attribute to ignore any alert <br />
                <br />
              </div>
          ...
          <div>
            <b>
              ...
              <span>
                {!blockRoute
                  ? "Form is not updated"
                  : "form is updated! blockRoute activated"}
              </span>
            </b>
          </div>
          <br />
  ...
  return (
    ...
    >
      <React.Fragment>
        ...
        <br />
        <div>
          Also you can use sendBeacon{" "}
          <a href="https://developer.mozilla.org/en-US/docs/Web/API/Navigator/sendBeacon">
            Click here to know more about sendBeacon
          </a>
        </div>
        <p>
          <b>
            beforeUnloadSendBeacon=
            {`{{ path: '/analytics', data: JSON.stringify({data:'data'}) }}`}
          </b>
        </p>
      </React.Fragment>
    </BeforeUnloadComponent>
...
const App = ({ location }) => {
  ...
  return (
    <div>
      ...
      <span> | </span>
      <a href="/form#i" custom-ignore="true">
        Form (This link is ignored)
      </a>
      <span> | </span>
